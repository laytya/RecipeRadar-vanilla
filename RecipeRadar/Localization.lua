...
if (GetLocale() == "esES") then
   -- the name of the addon!
   RecipeRadar_Strings["Recipe Radar"] = "Recipe Radar"

   -- these show up in the game's Key Bindings screen
   RecipeRadar_Strings["Toggle Recipe Radar"] = "Alternar a Recipe Radar"
   RecipeRadar_Strings["Recipe Radar Bindings"] = "Teclado del Recipe Radar"

   -- options button and corresponding options frame
   RecipeRadar_Strings["Options"] = "Opciones"
   RecipeRadar_Strings["Auto-map Contributive Vendors"] = "Auto-asignar vendedores contributivos"
   ...
   RecipeRadar_Strings["Minimap Button Position"] = "Posición del Icono del Minimapa"
   ...
   -- uncached recipe tooltip - see RecipeRadar_Availability_CreateTooltip()
   RecipeRadar_Strings["You may mouse over the [?]"] = "Puedes pasar el puntero del ratón al [?]"
   RecipeRadar_Strings["icon to lookup this recipe."] = "icono a las operaciones de búsqueda"
   RecipeRadar_Strings["Warning: if your server has"] = "Advertencia: ¡si tu servidor todavía"
   RecipeRadar_Strings["not yet seen this item, you"] = "no ha visto este artículo,"
   RecipeRadar_Strings["will be disconnected!"] = "te desconectarán!"
   ...
   RecipeRadar_Strings["Shift-click a vendor to add or remove her location on the world map."] = "Shift-clic a un vendedor para agregar o para quitar su localización en el mapa del mundo."

   -- strings in the faction filtering dropdown; we don't need 'Horde' or 'Alliance' because Blizzard provides them for us
   RecipeRadar_Strings["Factions"] = "Facciones"
   ...
   RecipeRadar_Strings["Available Now (Alts)"] = "Disponible Ahora (Alts)"
   RecipeRadar_Strings["Available Now (Player)"] = "Disponible Ahora (Jugador)"
   ...
   -- faction names for recipe reputation requirements
   RecipeRadar_Strings["Argent Dawn"] = "Alba Argenta"
   RecipeRadar_Strings["Cenarion Circle"] = "Círculo Cenarion"
   RecipeRadar_Strings["Thorium Brotherhood"] = "Hermandad del torio"
   RecipeRadar_Strings["Timbermaw Hold"] = "Bastión de los Fauces de Madera"
   ...
   RecipeRadar_Strings["Armorsmith"] = "Forjador de armaduras"
   RecipeRadar_Strings["Dragonscale Leatherworking"] = "Peletería dragontina"
   RecipeRadar_Strings["Elemental Leatherworking"] = "Peletería elemental"
   RecipeRadar_Strings["Goblin Engineer"] = "Ingeniero goblin"
   RecipeRadar_Strings["Master Axesmith"] = "Maestro forjador de hachas"
   RecipeRadar_Strings["Master Hammersmith"] = "Maestro forjador de martillos"
   RecipeRadar_Strings["Master Swordsmith"] = "Maestro invocador"
   RecipeRadar_Strings["Tribal Leatherworking"] = "Peletería tribal"
   RecipeRadar_Strings["Weaponsmith"] = "Forjador de armas"

   -- continent names for alternate region selection
   RecipeRadar_Strings["Kalimdor"] = "Kalimdor"
   ...
   -- some vendor names may need translating
   RecipeRadar_Strings["Abigail Shiel"] = "Abigail Shiel"
   RecipeRadar_Strings["Aendel Windspear"] = "Aendel Lanzavento"
   RecipeRadar_Strings["Alchemist Pestlezugg"] = "Alquimista Morterozugg"
   RecipeRadar_Strings["Alexandra Bolero"] = "Alexandra Bolero"
   RecipeRadar_Strings["Algernon"] = "Algernon"
   RecipeRadar_Strings["Amy Davenport"] = "Amy Davenport"
   RecipeRadar_Strings["Andrew Hilbert"] = "Andrew Hilbert"
   RecipeRadar_Strings["Androd Fadran"] = "Androd Fadran"
   ...
   RecipeRadar_Strings["Balai Lok'Wein"] = "Balai Lok'Wein"
   RecipeRadar_Strings["Bale"] = "Bale"
   RecipeRadar_Strings["Banalash"] = "Banalash"
   ...
   RecipeRadar_Strings["Bliztik"] = "Bliztik"
   RecipeRadar_Strings["Bombus Finespindle"] = "Bombus Bueneje"
   RecipeRadar_Strings["Borya"] = "Borya"
   RecipeRadar_Strings["Brienna Starglow"] = "Brienna Brillastrella"
   RecipeRadar_Strings["Bro'kin"] = "Bro'kin"
   RecipeRadar_Strings["Bronk"] = "Bronk"
   RecipeRadar_Strings["Catherine Leland"] = "Catherine Leland"
   RecipeRadar_Strings["Christoph Jeffcoat"] = "Christoph Jeffcoat"
   RecipeRadar_Strings["Clyde Ranthal"] = "Clyde Ranthal"
   RecipeRadar_Strings["Constance Brisboise"] = "Constance Brisboise"
   ...
   RecipeRadar_Strings["Dalria"] = "Dalria"
   RecipeRadar_Strings["Daniel Bartlett"] = "Daniel Bartlett"
   RecipeRadar_Strings["Danielle Zipstitch"] = "Danielle Puntillas"
   RecipeRadar_Strings["Darian Singh"] = "Darian Singh"
   RecipeRadar_Strings["Darnall"] = "Darnall"
   ...
   RecipeRadar_Strings["Elynna"] = "Elynna"
   RecipeRadar_Strings["Emrul Riknussun"] = "Emrul Riknussun"
   RecipeRadar_Strings["Erika Tate"] = "Erika Tate"
   RecipeRadar_Strings["Evie Whirlbrew"] = "Evie Brebegira"
   RecipeRadar_Strings["Fradd Swiftgear"] = "Fradd Cambioveloz"
   RecipeRadar_Strings["Fyldan"] = "Fyldan"
   RecipeRadar_Strings["Gagsprocket"] = "Dentolio"
   RecipeRadar_Strings["Gearcutter Cogspinner"] = "Cortallave Volopiñón"
   RecipeRadar_Strings["George Candarte"] = "George Candarte"
   RecipeRadar_Strings["Gharash"] = "Gharash"
   RecipeRadar_Strings["Ghok'kah"] = "Ghok'kah"
   RecipeRadar_Strings["Gigget Zipcoil"] = "Gigget Retramuelle"
   RecipeRadar_Strings["Gikkix"] = "Gikkix"
   RecipeRadar_Strings["Gina MacGregor"] = "Gina MacGregor"
   RecipeRadar_Strings["Gloria Femmel"] = "Gloria Femmel"
   RecipeRadar_Strings["Glyx Brewright"] = "Glyx Buenamezcla"
   RecipeRadar_Strings["Gnaz Blunderflame"] = "Gnaz Flamerrada"
   RecipeRadar_Strings["Gretta Ganter"] = "Gretta Ganter"
   RecipeRadar_Strings["Grimtak"] = "Grimtak"
   RecipeRadar_Strings["Hagrus"] = "Hagrus"
   RecipeRadar_Strings["Hammon Karwn"] = "Hammon Karwn"
   RecipeRadar_Strings["Harggan"] = "Harggan"
   ...
   RecipeRadar_Strings["Helenia Olden"] = "Helenia Olden"
   RecipeRadar_Strings["Himmik"] = "Himmik"
   RecipeRadar_Strings["Hula'mahi"] = "Hula'mahi"
   RecipeRadar_Strings["Jabbey"] = "Jabbey"
   RecipeRadar_Strings["Jandia"] = "Jandia"
   RecipeRadar_Strings["Janet Hommers"] = "Janet Hommers"
   RecipeRadar_Strings["Jangdor Swiftstrider"] = "Jangdor Zanco Veloz"
   RecipeRadar_Strings["Jannos Ironwill"] = "Jannos Dolocerado"
   RecipeRadar_Strings["Jaquilina Dramet"] = "Jaquilina Dramet"
   RecipeRadar_Strings["Jase Farlane"] = "Jase Farlane"
   RecipeRadar_Strings["Jazzrik"] = "Jazzrik"
   RecipeRadar_Strings["Jeeda"] = "Jeeda"
   RecipeRadar_Strings["Jennabink Powerseam"] = "Jennabink Costura Potente"
   RecipeRadar_Strings["Jessara Cordell"] = "Jessara Cordell"
   RecipeRadar_Strings["Jinky Twizzlefixxit"] = "Jinky Arreglatodo"
   RecipeRadar_Strings["Joseph Moore"] = "Joseph Moore"
   RecipeRadar_Strings["Jubie Gadgetspring"] = "Jubie Cacharretio"
   RecipeRadar_Strings["Jun'ha"] = "Jun'ha"
   RecipeRadar_Strings["Jutak"] = "Jutak"
   RecipeRadar_Strings["Kaita Deepforge"] = "Kaita Forjahonda"
   RecipeRadar_Strings["Kalldan Felmoon"] = "Kalldan Lunavil"
   RecipeRadar_Strings["Kania"] = "Kania"
   RecipeRadar_Strings["Keena"] = "Keena"
   RecipeRadar_Strings["Kelsey Yance"] = "Kelsey Yance"
   RecipeRadar_Strings["Kendor Kabonka"] = "Kendor Kabonka"
   RecipeRadar_Strings["Khara Deepwater"] = "Khara Aguahonda"
   RecipeRadar_Strings["Khole Jinglepocket"] = "Khole Calderilla"
   RecipeRadar_Strings["Kiknikle"] = "Kiknikle"
   RecipeRadar_Strings["Killian Sanatha"] = "Killian Sanatha"
   RecipeRadar_Strings["Kilxx"] = "Kilxx"
   RecipeRadar_Strings["Kireena"] = "Kireena"
   RecipeRadar_Strings["Kithas"] = "Kithas"
   RecipeRadar_Strings["Knaz Blunderflame"] = "Knaz Flamerrada"
   RecipeRadar_Strings["Kor'geld"] = "Kor'geld"
   RecipeRadar_Strings["Kriggon Talsone"] = "Kriggon Talsone"
   RecipeRadar_Strings["Krinkle Goodsteel"] = "Krinkle Buenacero"
   RecipeRadar_Strings["Kulwia"] = "Kulwia"
   RecipeRadar_Strings["Kzixx"] = "Kzixx"
   RecipeRadar_Strings["Laird"] = "Laird"
   RecipeRadar_Strings["Lardan"] = "Lardan"
   RecipeRadar_Strings["Leo Sarn"] = "Leo Sarn"
   RecipeRadar_Strings["Leonard Porter"] = "Leonard Porter"
   RecipeRadar_Strings["Lilly"] = "Lilly"
   RecipeRadar_Strings["Lindea Rabonne"] = "Lindea Rabonne"
   RecipeRadar_Strings["Lizbeth Cromwell"] = "Lizbeth Cromwell"
   RecipeRadar_Strings["Logannas"] = "Logannas"
   ...
   RecipeRadar_Strings["Mahu"] = "Mahu"
   RecipeRadar_Strings["Mallen Swain"] = "Mallen Swain"
   RecipeRadar_Strings["Malygen"] = "Malygen"
   RecipeRadar_Strings["Maria Lumere"] = "Maria Lumere"
   RecipeRadar_Strings["Martine Tramblay"] = "Martine Tramblay"
   RecipeRadar_Strings["Masat T'andr"] = "Masat T'andr"
   RecipeRadar_Strings["Master Craftsman Omarion"] = "Maestro artesano Omarion"
   RecipeRadar_Strings["Mavralyn"] = "Mavralyn"
   RecipeRadar_Strings["Mazk Snipeshot"] = "Mazk Tirocertero"
   RecipeRadar_Strings["Meilosh"] = "Meilosh"
   RecipeRadar_Strings["Micha Yance"] = "Micha Yance"
   RecipeRadar_Strings["Millie Gregorian"] = "Millie Gregorian"
   RecipeRadar_Strings["Mishta"] = "Mishta"
   RecipeRadar_Strings["Montarr"] = "Montarr"
   RecipeRadar_Strings["Muuran"] = "Muuran"
   RecipeRadar_Strings["Mythrin'dir"] = "Mythrin'dir"
   RecipeRadar_Strings["Naal Mistrunner"] = "Naal Correbruma"
   RecipeRadar_Strings["Namdo Bizzfizzle"] = "Namdo Silvabín"
   RecipeRadar_Strings["Nandar Branson"] = "Nandar Branson"
   RecipeRadar_Strings["Nardstrum Copperpinch"] = "Nardstrum Cobrellizco"
   RecipeRadar_Strings["Narj Deepslice"] = "Narj Tajofondo"
   RecipeRadar_Strings["Narkk"] = "Narkk"
   RecipeRadar_Strings["Nata Dawnstrider"] = "Nata Caminalba"
   RecipeRadar_Strings["Nergal"] = "Nergal"
   RecipeRadar_Strings["Nerrist"] = "Nerrist"
   RecipeRadar_Strings["Nessa Shadowsong"] = "Nessa Cantosombrío"
   RecipeRadar_Strings["Nina Lightbrew"] = "Nina Burbuluz"
   RecipeRadar_Strings["Nioma"] = "Nioma"
   RecipeRadar_Strings["Nyoma"] = "Nyoma"
   RecipeRadar_Strings["Ogg'marr"] = "Ogg'marr"
   RecipeRadar_Strings["Old Man Heming"] = "Viejo Heming"
   RecipeRadar_Strings["Otho Moji'ko"] = "Otho Moji'ko"
   ...
   RecipeRadar_Strings["Pratt McGrubben"] = "Pratt McGrubben"
   RecipeRadar_Strings["Qia"] = "Qia"
   RecipeRadar_Strings["Quartermaster Miranda Breechlock"] = "Intendente Miranda Cerrobrecha"
   RecipeRadar_Strings["Ranik"] = "Ranik"
   RecipeRadar_Strings["Rann Flamespinner"] = "Rann Flamejes"
   RecipeRadar_Strings["Rartar"] = "Rartar"
   RecipeRadar_Strings["Rikqiz"] = "Rikqiz"
   RecipeRadar_Strings["Rin'wosho the Trader"] = "Rin'wosho el Comerciante"
   RecipeRadar_Strings["Rizz Loosebolt"] = "Rizz Tornillosuelto"
   RecipeRadar_Strings["Ronald Burch"] = "Ronald Burch"
   RecipeRadar_Strings["Ruppo Zipcoil"] = "Rupo Retramuelle"
   RecipeRadar_Strings["Saenorion"] = "Saenorion"
   RecipeRadar_Strings["Seersa Copperpinch"] = "Seersa Cobrellizco"
   RecipeRadar_Strings["Sewa Mistrunner"] = "Seua Correbruma"
   RecipeRadar_Strings["Shandrina"] = "Shandrina"
   RecipeRadar_Strings["Shankys"] = "Shankys"
   ...
   RecipeRadar_Strings["Sovik"] = "Sovik"
   RecipeRadar_Strings["Stuart Fleming"] = "Stuart Fleming"
   RecipeRadar_Strings["Sumi"] = "Sumi"
   RecipeRadar_Strings["Super-Seller 680"] = "Supervendedor 680"
   RecipeRadar_Strings["Tamar"] = "Tamar"
   RecipeRadar_Strings["Tansy Puddlefizz"] = "Tansy Burbajea"
   RecipeRadar_Strings["Tarban Hearthgrain"] = "Tarban Granogar"
   RecipeRadar_Strings["Tari'qa"] = "Tari'qa"
   RecipeRadar_Strings["Thaddeus Webb"] = "Thaddeus Webb"
   RecipeRadar_Strings["Tharynn Bouden"] = "Tharynn Bouden"
   RecipeRadar_Strings["Tilli Thistlefuzz"] = "Tilli Cardopelusa"
   RecipeRadar_Strings["Truk Wildbeard"] = "Truk Barbaje"
   RecipeRadar_Strings["Tunkk"] = "Tunkk"
   RecipeRadar_Strings["Ulthaan"] = "Ulthaan"
   RecipeRadar_Strings["Ulthir"] = "Ulthir"
   RecipeRadar_Strings["Uthok"] = "Uthok"
   RecipeRadar_Strings["Vaean"] = "Vaean"
   RecipeRadar_Strings["Valdaron"] = "Valdaron"
   RecipeRadar_Strings["Vargus"] = "Vargus"
   RecipeRadar_Strings["Veenix"] = "Veenix"
   RecipeRadar_Strings["Vendor-Tron 1000"] = "Vende-Tron 1000"
   RecipeRadar_Strings["Vharr"] = "Vharr"
   RecipeRadar_Strings["Vivianna"] = "Vivianna"
   RecipeRadar_Strings["Vizzklick"] = "Vizzklick"
   RecipeRadar_Strings["Wenna Silkbeard"] = "Wenna Barbasedosa"
   RecipeRadar_Strings["Werg Thickblade"] = "Werg Filo Grueso"
   RecipeRadar_Strings["Wik'Tar"] = "Wik'Tar"
   RecipeRadar_Strings["Worb Strongstitch"] = "Worb Puntofuerte"
   RecipeRadar_Strings["Wrahk"] = "Wrahk"
   RecipeRadar_Strings["Wulan"] = "Wulan"
   RecipeRadar_Strings["Wulmort Jinglepocket"] = "Wulmort Calderilla"
   RecipeRadar_Strings["Wunna Darkmane"] = "Wunna Crin Oscura"
   RecipeRadar_Strings["Xandar Goodbeard"] = "Xandar Bonbarba"
   RecipeRadar_Strings["Xen'to"] = "Xen'to"
   RecipeRadar_Strings["Xizk Goodstitch"] = "Xizk Cortefino"
   RecipeRadar_Strings["Xizzer Fizzbolt"] = "Xizzer Raybuja"
   RecipeRadar_Strings["Yonada"] = "Yonada"
   ...
   RecipeRadar_Strings["Zansoa"] = "Zansoa"
   RecipeRadar_Strings["Zarena Cromwind"] = "Zarena Cromvento"
   RecipeRadar_Strings["Zargh"] = "Zargh"
   RecipeRadar_Strings["Zixil"] = "Zixil"
   RecipeRadar_Strings["Zorbin Fandazzle"] = "Zorbin Hipnoviento"
